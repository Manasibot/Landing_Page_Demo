    ...
    <footer className="relative overflow-hidden py-8 border-t border-dark-700">
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col items-center text-center">
          {/* Logo + text as one unit, centered */}
          <div className="w-full flex justify-center mb-1">
            <motion.a
              ...
              viewport={{ once: true }}
              className="flex items-start gap-0 group shrink-0 -translate-x-4"
            >
              <div className="-mt-5">
                <Image
                  src={LogoImg}
          ...
          <div className="space-y-1 text-center">
            ...
            <p className="text-primary-500 text-xs tracking-widest uppercase font-bold">
